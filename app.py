...
BC = {
    ...
    # ── MX Tier 2: mayo 2026 ─────────────────────────────────────────
    "TuConta.Cloud":   "#00B894", "ContaFix":        "#FDCB6E",
    "Verifisca":       "#E17055", "WinCaja":         "#74B9FF",
    "BusinessBay":     "#A29BFE", "Integra ERP":     "#55EFC4",
    "BITSAR":          "#FD79A8", "CuentIA":         "#00CEC9",
    "Libertyfin":      "#E84393", "Coconut Control": "#BADC58",
    "Syska POS":       "#F9CA24", "Abaccor":         "#6AB04C",
    "Tesio":           "#EB4D4B", "Uxi":             "#7ED6DF",
    "MXPyme":          "#E55039", "Alendum ERP":     "#F0932B",
    "NexFiscal":       "#686DE0", "CumpleAI":        "#30336B",
    "Sicaja":          "#C7ECEE", "Controlisis ERP": "#778CA3",
    "SenHub Factura":  "#F8A5C2", "ConElFerretero":  "#63CDDA",
    "MYMS Software":   "#EA8685", "Kladi":           "#596275",
    "SimpliFac":       "#E77F67", "DaMap":           "#3DC1D3",
    # ── MX Tier 3: barrido exhaustivo mayo 2026 ───────────────────────
    "OS Manager POS":  "#ED4C67", "Vende Pro":       "#F79F1F",
    "FactuLink":       "#A3CB38", "Angaflow":        "#1289A7",
    "Kordata":         "#C4E538", "Contafiscal C2K": "#D980FA",
    "Sistema B4":      "#9980FA", "ContaDB":         "#FDA7DF",
    "XML Manager":     "#12CBC4", "Zionyx ERP":      "#B53471",
    "ExpertEasy ERP":  "#EE5A24", "EverPOS":         "#009432",
    "FacturaGo":       "#006266", "SIGA Contable":   "#1B1464",
    "Contalinea":      "#5758BB", "Cofers":          "#6F1E51",
    "Actiun":          "#4D8FAC", "Wizerp":          "#F8EFBA",
    "Pixcua Suite":    "#BDC581", "Soft Restaurant": "#E55039",
    "Bsale":           "#40739E", "AdminCase":       "#7F8C8D",
    "Domo Fiscal":     "#16A085", "Kontia":          "#8E44AD",
    "FactuBot":        "#2980B9", "WMSPos":          "#E67E22",
    "Overseer POS":    "#E74C3C", "APIFactura.mx":   "#27AE60",
    "FiscalCloud":     "#2C3E50", "KEPLER ERP":      "#F39C12",
    "BeeuPos":         "#D35400", "Facture App":     "#7DCEA0",
    "ACTIF 7":         "#A569BD",
    # ── CO ────────────────────────────────────────────────────────────
    ...
    "PhantomApp":      "#DAE8FC",
    # ── CO Tier 3: barrido completo mayo 2026 ─────────────────────────
    "VeinteGeras":     "#FF9F43", "Lemp":            "#EE5A24",
    "Bitácora":        "#C44569", "J2 Software POS": "#786FA6",
    "Scrampi":         "#F8EFBA", "Innapsis":        "#63CDDA",
    "Factum":          "#CF6A87", "Factronik":       "#574B90",
    "ContaCol":        "#3DC1D3", "Zoenube":         "#F3A683",
    "Ally360":         "#778CA3", "Korapos":         "#E77F67",
    "NexoGestión":     "#55E6C1", "Farmatízate POS": "#F19066",
    "Afacturar":       "#B8E994", "FACNET":          "#78E08F",
    "Tribualdía":      "#EA8685", "Zenter":          "#596275",
    "Sygna":           "#82CCDD", "Rippling":        "#60A3BC",
    "Payfit":          "#B8D8D8",
    # ── CO Tier 4: barrido ChatGPT mayo 2026 ─────────────────────────
    "Runa":            "#FD7272", "EDICOM":          "#9AECDB",
    "TecsiPOS":        "#D6A2E8", "TiendaUP":        "#FEA47F",
    "Galaxia POS":     "#25CCF7", "Mayora POS":      "#EAB543",
    "Extragerto":      "#58B19F", "Siivro":          "#CAD3C8",
    "MiRemuner":       "#F97F51", "ADP Run":         "#1B9CFC",
    "SYSplus":         "#B8E994", "ADEstock":        "#FC427B",
    "Firmflow":        "#BDC581", "Nexus ERP":       "#182C61",
    # ── DO ────────────────────────────────────────────────────────────
